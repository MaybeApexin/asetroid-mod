...
public class ModItems {
    ...
    public static final Item X_BOW = new Item(new Item.Settings().group(ModItemGroups.ITEM_GROUP));

    public static void registerItems() {
         Registry.register(Registry.ITEM, new Identifier(Asteroid.MOD_ID, "x_sword"),X_SWORD);
         Registry.register(Registry.ITEM, new Identifier(Asteroid.MOD_ID, "x_bow"), X_BOW);
    }
}
